...
public class BlobAttack extends PApplet {
    float playerX = 256;
    float playerY = 352;
    ...
    public static void main(String[] args) {
        PApplet.main("globattack.BlobAttack");
    }
    ...
    public void setup() {
        ...
        playerBlob = loadImage("Images/BlobFish_smaller.png");
    ...
    public void drawPlayer() {
        ...
        image(playerBlob, playerX, playerY);
    }
